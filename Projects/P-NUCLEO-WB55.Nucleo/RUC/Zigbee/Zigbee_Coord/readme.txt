/**
  @page Zigbee_Coord application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_Coord/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the Zigbee Coordinator application using   
  *          persistent data. 
  ******************************************************************************
  *
...
- 1 or more STM32WB55xx board loaded with: 
    ...
    - application : Zigbee_OnOff_Router_NVM
                  ...
                  Device 1                                       Device 2
                  (Router)                                    (Coordinator)
           Zigbee_OnOff_Router_NVM                        Zigbee_Coord
